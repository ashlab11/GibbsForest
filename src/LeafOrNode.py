...
class LeafOrNode:
    ...
    def get_best_split(self, X, y, other_predictions, num_cols_other_prediction, features_to_consider, eta):
        ...
        if self.left == None and self.right == None:
            return self.get_best_split_leaf(X, y, other_predictions, num_cols_other_prediction, features_to_consider, eta)
        else:
            return self.get_best_split_node(X, y, other_predictions, num_cols_other_prediction, features_to_consider, eta)
        
    def get_best_split_node(self, X, y, other_predictions, num_cols_other_prediction, features_to_consider, eta):
        ...
        left_best_error_reduction, left_col_split = self.left.get_best_split(left_X, left_y, left_other_predictions, num_cols_other_prediction, features_to_consider, eta)
    ...
    def get_best_split_leaf(self, X, y, other_predictions, num_cols_other_prediction, features_to_consider, eta):
