...
class LeafOrNode:
    ...
    def get_best_split(self, X, y, other_predictions, tree_weight, eta):
        ...
        if self.left == None and self.right == None:
            return self.get_best_split_leaf(X, y, other_predictions, tree_weight, eta)
        else:
            return self.get_best_split_node(X, y, other_predictions, tree_weight, eta)
        
    def get_best_split_node(self, X, y, other_predictions, tree_weight, eta):
        ...
        left_best_error_reduction, left_col_split = self.left.get_best_split(left_X, left_y, left_other_predictions, tree_weight, eta)
        right_best_error_reduction, right_col_split = self.right.get_best_split(right_X, right_y, right_other_predictions, tree_weight, eta)
    ...
    def get_best_split_leaf(self, X, y, other_predictions, tree_weight, eta):
        ...
        gain, col, splitting_val, left_val, right_val = find_split(
            X, y, other_predictions, self.val, tree_weight, features_to_consider=range(len(X[0])), min_samples=self.min_samples,
